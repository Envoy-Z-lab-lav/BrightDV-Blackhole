...
class AppLocalizationsEl extends AppLocalizations {
  ...
  @override
  String get aboutLine1 => 'Αυτό είναι ένα πρόγραμμα ανοιχτού κώδικα και μπορεί να βρεθεί στο';

  @override
  String get aboutLine2 => 'Αν σου άρεσε η δουλειά μου\nδείξε ♥ και ⭐ το repo';

  @override
  String get accent => 'Accent Color & Hue';

  @override
  String get addNew => 'Πρόσθεσε νέο';

  @override
  String get addSomething => 'Πάνε και πρόσθεσε κάτι';

  @override
  String get addToPlaylist => 'Προσθήκη στην λίστα αναπαραγωγής';

  @override
  String get addToQueue => 'Προσθήκη στην ουρά';

  @override
  String get addedBy => 'Προστέθηκε απο';

  @override
  String get addedTo => 'Προστέθηκε στο';

  @override
  String get addedToFav => 'Προστέθηκε στα Αγαπημένα';

  @override
  String get addedToPlaylists => 'Προστέθηκε στην λίστα αναπαραγωγής';

  @override
  String get addedToQueue => 'Προστέθηκε στην ουρά';

  @override
  String get adjustSpeed => 'Ρύθμιση ταχύτητας';
  ...
  @override
  String get alphabetical => 'Αλφαβητικά';

  @override
  String get alreadyExists => 'Υπάρχει ίδη';

  @override
  String get alreadyInQueue => 'Ίδη στην ουρά';
  ...
  @override
  String get cantAddToQueue => 'Δεν μπορείς να προσθέσεις διαδικτυακό τραγούδι σε ουρά εκτός σύνδεσης';
  ...
  @override
  String get cardColorSub => 'Χρώμα γραμμής αναζήτησης, διαλόγων ειδοποιήσεων, καρτών';
  ...
  @override
  String get changeOrder => 'Πατήστε παρατεταμένα για αλλαγή σειράς\n';

  @override
  String get chartLocation => 'Τοπικά γραφήματα Spotify';

  @override
  String get chartLocationSub => 'Χώρα για τα κορυφαία τοπικά γραφήματα του Spotify';

  @override
  String get checkingUpdate => 'Έλεγχος για ενημερώσεις…';

  @override
  String get checkUpdate => 'Αυτόματος έλεγχος για ενημερώσεις';
  ...
  @override
  String get confirmViewable => 'Βεβαιωθείτε ότι η λίστα αναπαραγωγής είναι ορατή';

  @override
  String get connectingRadio => 'Σύνδεση στο ραδιόφωνο…';

  @override
  String get contactUs => 'Επικοινωνήστε μαζί μας';

  @override
  String get contactUsSub => 'Τα σχόλια εκτιμήθηκαν!';

  @override
  String get convertingSongs => 'Μετατροπή τραγουδιών';
