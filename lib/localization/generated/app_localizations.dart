...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Enable Volume Gesture Controls'**
  String get volumeGestureEnabled;

  /// No description provided for @volumeGestureEnabledSub.
  ///
  /// In en, this message translates to:
  /// **'Use vertical swipe on the Artwork in Player Screen to control volume instead of sliding player down'**
  ...
  /// No description provided for @navTabs.
  ///
  /// In en, this message translates to:
  /// **'Navigation Bar Tabs'**
  String get navTabs;

  /// No description provided for @navTabsSub.
  ///
  /// In en, this message translates to:
  /// **'Tabs to be shown in bottom navigation bar'**
  String get navTabsSub;
  ...
  ///
  /// In en, this message translates to:
  /// **'Show Spotify Top Charts on Home Screen'**
  ...
  ///
  /// In en, this message translates to:
  /// **'This will be used whenever Wifi is connected'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Not from India? Try using Proxy or VPN with Indian Server'**
  String get useVpn;
  ...
  ///
  /// In en, this message translates to:
  /// **'Either Video is live or some error occured. Please wait until the live stream finishes or try again.'**
...
class _AppLocalizationsDelegate extends LocalizationsDelegate<AppLocalizations> {
  ...
  @override
  bool isSupported(Locale locale) => <String>['ar', 'be', 'bn', 'ca', 'cs', 'da', 'de', 'el', 'en', 'es', 'fa', 'fr', 'gu', 'he', 'hi', 'hu', 'ia', 'id', 'it', 'ja', 'km', 'kn', 'ko', 'ml', 'mn', 'mr', 'ms', 'ne', 'nl', 'or', 'pa', 'pl', 'pt', 'ru', 'sq', 'sv', 'ta', 'te', 'tr', 'uk', 'ur', 'vi', 'zh'].contains(locale.languageCode);
...
case 'Hant': return AppLocalizationsZhHant();
  ...
  switch (locale.countryCode) {
    case 'PAL': return AppLocalizationsFaPal();
   }
  break;
   }
  }
