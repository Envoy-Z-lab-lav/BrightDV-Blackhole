...
class AppLocalizationsTe extends AppLocalizations {
  ...
  @override
  String get aboard => 'అతిథి';

  @override
  String get about => 'నా గురించి';

  @override
  String get aboutLine1 => 'ఇది ఒక ఓపెన్ సోర్స్ ప్రాజెక్ట్ మరియు దీనిలో కనుగొనవచ్చు';

  @override
  String get aboutLine2 => 'నా వర్క్ నచ్చితే\n కొంత ప్రేమతో రిపో కి ⭐ ఇవ్వండి';

  @override
  String get accent => 'యాక్సెంట్ కలర్ & హ్యూ';

  @override
  String get addNew => 'కొత్తవి జోడించండి';

  @override
  String get addSomething => 'వెళ్లి ఏదైనా జోడించండి';

  @override
  String get addToPlaylist => 'పాటల క్రమంలో చేర్చు';

  @override
  String get addToQueue => 'క్యూకి జోడించండి';

  @override
  String get addedBy => 'చేర్చారు';
  ...
  @override
  String get albumArtist => 'ఆల్బమ్ కళాకారుడు';

  @override
  String get albums => 'ఆల్బమ్';
  ...
  @override
  String get blacklistHomeSectionsConfirm => 'ఈ విభాగాన్ని బ్లాక్ లిస్ట్ లో పెట్టాలని మీరు ఖచ్చితంగా అనుకుంటున్నారా? ఒకసారి బ్లాక్ లిస్ట్ లో పెట్టిన తర్వాత, ఇది హోమ్ స్క్రీన్ పై చూపబడదు';

  @override
  String get blacklistedHomeSections => 'Blacklisted Home Sections';

  @override
  String get blacklistedHomeSectionsSub => 'ఈ శీర్షికలతో ఉన్న విభాగాలు హోమ్ స్క్రీన్ పై చూపబడవు';
  ...
  @override
  String get cacheSongSub => 'భవిష్యత్ ప్లేబ్యాక్ కోసం పాటలను క్యాచీ చేయనున్నారు. మీ పరికరంలో అదనపు స్థలం తీసుకోబడుతుంది';
  ...
  @override
  String get clearCacheSub => 'హోమ్ పేజీ, స్పాటిఫై టాప్ చార్ట్ లు, యూట్యూబ్ మరియు లాస్ట్ సెషన్ డేటాతో సహా క్యాచీడ్ వివరాలను తొలగిస్తుంది. సాధారణంగా డేటా పెద్దదిగా మారినప్పుడు యాప్ ఆటోమేటిక్ గా వాటిని క్లియర్ చేస్తుంది.\n';
  ...
  @override
  String get countryQue => 'మీరు ఏ దేశం కొరకు స్పాటిఫై లోకల్ చార్ట్ లను చూడాలనుకుంటున్నారు?';

  @override
  String get createAlbumFold => 'Create folder for Album & Playlist Download';

  @override
  String get createAlbumFoldSub => 'ఆల్బమ్ లేదా ప్లేజాబితాను డౌన్ లోడ్ చేసినప్పుడు పాటల కోసం సాధారణ సంచికను సృష్టిస్తుంది';
  ...
  @override
  String get createYtFoldSub => 'యూట్యూబ్ నుండి డౌన్ లోడ్ చేసిన పాటల కోసం వేరే సంచికను సృష్టిస్తుంది';
  ...
  @override
  String get disclaimerText => 'మేము మీ గోప్యతను అన్నింటికంటే ఎక్కువగా గౌరవిస్తాము. మీ డేటా మొత్తం మీ పరికరంలో మాత్రమే స్థానికంగా నిల్వ చేయబడుతుంది.';

  @override
  String get displayName => 'Display Name';

  @override
  String get donateGpay => 'Donate with GPay';

  @override
  String get donateGpaySub => 'ప్రతి చిన్న మొత్తం నన్ను :) నవ్విస్తుంది.\nదానం చేయడానికి ట్యాప్ చేయండి లేదా యుపిఐ ఐడిని కాపీ చేయడానికి లాంగ్ ప్రెస్ చేయండి';

  @override
  String get down => 'Download';

  @override
  String get downAgain => 'ఇప్పటికే ఉంది.\nమీరు దీన్ని మళ్లీ డౌన్ లోడ్ చేయాలని అనుకుంటున్నారా?';
  ...
  @override
  String get downFilenameSub => 'ఈ ఫైల్ నేమ్ ఫార్మాట్ ప్రకారం పాటలు డౌన్ లోడ్ చేయబడతాయి';
  ...
  @override
  String get enableGestureSub => 'ప్లేయర్ స్క్రీన్ లోని ఆర్ట్ వర్క్ పై ట్యాప్ చేయడం, లాంగ్రెస్ చేయడం, స్వైప్ చేయడం మొదలైన వాటిని ఎనేబుల్ చేస్తుంది';
  ...
  @override
  String get getLyricsOnlineSub => 'ఏదైనా ఆఫ్ లైన్ పాట కోసం లిరిక్స్ లభ్యం కానట్లయితే/డౌన్ లోడ్ చేయకపోతే ఆన్ లైన్ లో శోధించండి';
  ...
  @override
  String get langQue => 'మీరు ఏ భాషా పాటలు వినడానికి ఇష్టపడతారు?';
  ...
  @override
  String get minAudioLenSub => 'దీని కంటే తక్కువ నిడివి ఉన్న ఆడియోలు \'మై మ్యూజిక్\' సెక్షన్ లో చూపించబడవు';
  ...
  @override
  String get noLangSelected => 'మ్యూజిక్ లాంగ్వేజ్ ఎంచుకోబడలేదు. హోమ్ స్క్రీన్ పై పాటలను చూడటానికి భాషను ఎంచుకోండి';
  ...
  @override
  String get restoreSub => 'బ్యాకప్ నుండి మీ డేటాను పునరుద్ధరించండి.\nమీరు యాప్ ని పునఃప్రారంభించాల్సి ఉండవచ్చు\n';
  ...
  @override
  String get supportEqSub => 'ఒకవేళ మీరు పాటలను ప్లే చేయలేకపోతే (ఆన్ లైన్ మరియు ఆఫ్ లైన్ మోడ్ రెండింటిలోనూ) దీనిని ఆఫ్ చేయండి';
  ...
  @override
  String get useBlurForNowPlayingSub => 'తక్కువ ఓపాసిటీ ఉన్న బ్లర్ ఇప్పుడు ప్లేయింగ్ సెక్షన్ యొక్క బ్యాక్ గ్రౌండ్ గా ఉపయోగించబడుతుంది';

  @override
  String get useDown => 'Stream Downloaded Songs, If available';

  @override
  String get useDownSub => 'పాట ఇప్పటికే డౌన్ లోడ్ చేయబడి ఉంటే, ఆన్ లైన్ లో స్ట్రీమింగ్ చేయడానికి బదులుగా డౌన్ లోడ్ చేయబడ్డ పాట ప్లే చేయబడుతుంది';
  ...
  @override
  String get ytLiveAlert => 'వీడియో లైవ్ లో ఉంది లేదా ఏదైనా దోషం సంభవించింది. ప్రత్యక్ష ప్రసారం పూర్తయ్యే వరకు దయచేసి వేచి ఉండండి లేదా మళ్లీ ప్రయత్నించండి.';
